...
/*   Updated: 2023/02/05 21:47:10 by hiroaki          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//		ft_putchar_fd(' ', fd);
//	if (!(flag & SPEC_C) && !(flag & SPEC_S) && info->sign == 0 && flag & SPACE)
//		ft_putchar_fd(' ', fd);
//	if (!(flag & SPEC_C) && !(flag & SPEC_S) && info->sign > 0)
//		ft_putchar_fd(info->sign, fd);
//	while (flag & SPEC_IDPUX && 0 < info->prec-- || (!(flag & ALIGN) && flag & ZERO && 0 < info->width--))
//		ft_putchar_fd('0', fd);
//	while (0 < info->len--)
//	{
//		if (*str == '-')
